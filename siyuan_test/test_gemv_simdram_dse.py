...
rank_count_range = [16, 32, 64]
col_count_range = [128, 256, 512]
bank_count_range = [16, 32, 64]
device_count_range = [4, 8, 16]

# rank_count_range = [64]
# col_count_range = [128, 256, 512]
# bank_count_range = [16]
# device_count_range = [16]
...
for rank_count in rank_count_range:
    for col_count in col_count_range:
        for bank_count in bank_count_range:
...
with open('test_gemv_simdram_dse.csv', 'w', newline='') as file:
