#!/bin/bash
cd ../..
python -m experiments.test_gemm_ddr5_multiprocess --config configs/x16_proteus_like.json --M 1024 --K 49152 --N 12288 --precision int8 --use_strategy exp_scripts/breakdown/gemm_breakdown/gemm_strategy.json
cd -
